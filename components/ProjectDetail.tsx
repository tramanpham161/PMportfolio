  ...
  return (
    <div className="fixed inset-0 z-[100] bg-linen overflow-y-auto animate-in fade-in duration-500">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-16 md:py-24">
        {/* Project Hero Header - Expanded and with improved letter spacing */}
        <div className="mb-16">
          <span className="font-mono text-xs font-bold uppercase tracking-[0.3em] text-sage mb-6 block">Case Study / Overview</span>
          {/* Improved tracking from tight to 0.05em for better uppercase aesthetics */}
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-[0.05em] leading-[0.95] mb-4">
            {project.name}
          </h1>
          {project.tagline && (
          ...
          {/* Problem section spans the whole width */}
        ...
        {/* Description Section - Now spanning the whole width before the grid metadata */}
          ...
          <div className="space-y-10 max-w-5xl">
            ...
            {project.research && (
              <div className="space-y-3">
                <h4 className="font-mono text-[10px] font-bold uppercase tracking-widest text-clay">Research & Immersion</h4>
                <p className="text-lg md:text-xl font-medium leading-relaxed text-charcoal/80">{project.research}</p>
              </div>
            )}
            {project.solution && (
              <div className="space-y-3">
                <h4 className="font-mono text-[10px] font-bold uppercase tracking-widest text-clay">The Outcome</h4>
        ...
        {/* Strategy Grid for Secondary details */}
        <div className="grid lg:grid-cols-12 gap-12 md:gap-16 items-start">
          <div className="lg:col-span-7 space-y-12">
            {/* Strategic Outcomes */}
            {project.outcomes && (
              <section className="bg-charcoal text-linen p-8 md:p-12 rounded-[2rem] space-y-8">
                <h2 className="font-mono text-[10px] font-bold uppercase tracking-[0.3em] text-clay">Impact & Evolution</h2>
                <p 
              ...
              <div className="pt-6 border-t border-charcoal/10">
                <div className="flex items-center space-x-4">
                  ...
                  <p className="text-sm font-bold uppercase tracking-widest text-sage">
                    Skills applied: <span className="text-charcoal">{project.skillsSignal}</span>
                  </p>
                </div>
              </div>
            )}
